...
/*   Updated: 2024/04/16 16:24:52 by martorre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	draw_player_icon(t_img *map, t_vec2 dir)
{
	...
	center = create_vector2d(MMAP_SIZE * GRID_UNIT / 2, MMAP_SIZE * GRID_UNIT
			/ 2);
	v = scalar_vec2(normalize_vec2(create_vector2d(dir.y, dir.x)), GRID_UNIT
			* 0.5);
